...
public class PosteController {
	public @FXML TextArea ListCP = new TextArea();
	public @FXML TextArea ListPeP = new TextArea();
	public @FXML TextArea ListSeR = new TextArea();
	public @FXML TextArea ListUO = new TextArea();
	public Vector<String> VCP = new Vector<String>();
	public Vector<String> VPeP = new Vector<String>();
	public Vector<String> VSeR = new Vector<String>();
	public Vector<String> VUO = new Vector<String>();
